d3 = function() {
  ...
  var d3_time_formats = {
    ...
    t: function(d, p) {
      return d3_time_formatPad((d.getFullYear() + 543) % 100, p, 2);
    },
    T: function(d, p) {
      return d3_time_formatPad((d.getFullYear() + 543) % 1e4, p, 4);
    },
    U: function(d, p) {
  ...
  var d3_time_parsers = {
    ...
    t: d3_time_parseThaiYear,
    T: d3_time_parseThaiFullYear,
  ...
  function d3_time_parseThaiFullYear(date, string, i) {
    d3_time_numberRe.lastIndex = 0;
    var n = d3_time_numberRe.exec(string.substring(i, i + 4));
    return n ? (date.y = +n[0] - 543, i + n[0].length) : -1;
  }
  function d3_time_parseThaiYear(date, string, i) {
    d3_time_numberRe.lastIndex = 0;
    var n = d3_time_numberRe.exec(string.substring(i, i + 2));
    return n ? (date.y = d3_time_expandYear(+n[0]) - 43, i + n[0].length) : -1;
  }
